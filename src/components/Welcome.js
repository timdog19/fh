            ...
            <Box mx={[4, 4, 16, 32]} my={64}>
                <HStack spacing={0}>
                    ...
                    <VStack spacing={16}>
                        ...
                        <Text align="center" w={["80%", "75%", "70%", "70%"]} fontSize={24}>Join  the  Funky Horse Pub  Community! We’re  a  community  of  10000 hand drawn stored  as  ERC-721  tokens  on the Avax  network.</Text>
